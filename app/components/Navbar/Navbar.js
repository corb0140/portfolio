  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed flex w-full h-24 z-40 items-center justify-between px-10"
      >
        ...
        {/* Navbar Menu */}
        <ul className="gap-x-10 text-sm hidden lg:flex">
        ...
        {/* Hamburger Menu */}
        <div
          className="lg:hidden relative flex flex-col gap-[0.4rem] [transform:rotateY(180deg)] hover:cursor-pointer"
          onClick={() => {
