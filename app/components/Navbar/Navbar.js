...
import NavMenu from "@/app/UI/Modals/NavMenu";
  ...
  return (
    <>
      <motion.nav
        ...
        className="fixed w-full h-24 z-40 flex items-center justify-between px-5 lg:hidden"
      >
      ...
      <AnimatePresence>
        {showMobileMenu && (
          <NavMenu close={toggleMobileMenu} animate={menuAnimation} />
        )}
      </AnimatePresence>
      ...
      <motion.nav
        ...
        className="hidden lg:fixed lg:flex w-full h-24 z-40 lg:items-center lg:justify-between px-10"
      >
        <div onClick={goBack} className="hover:cursor-pointer">
          <svg
            viewBox="0 0 200 200"
